...
export const chapterMaps: Record<ChapterId, ChapterMap> = {
  ...
  rain: {
    ...
    entities: [
      { id: 'entity.rain.ticket', label: '泡软的旧车票', x: 180, y: 580, kind: 'pickup' },
      { id: 'entity.rain.stone_2', label: '两个圆点', x: 330, y: 520, kind: 'puzzle' },
      { id: 'entity.rain.stone_4', label: '四个圆点', x: 510, y: 440, kind: 'puzzle' },
      { id: 'entity.rain.stone_5', label: '五个圆点', x: 680, y: 370, kind: 'puzzle' },
      {
  ...
  life: {
    ...
    entities: [
      ...
      { id: 'item.photo.osmanthus_1992', label: '桂花窗台照片', x: 485, y: 400, kind: 'pickup' },
      { id: 'item.photo.anniversary_2001', label: '银婚照片', x: 885, y: 420, kind: 'pickup' },
      { id: 'entity.life.album', label: '空着三格的相册', x: 581, y: 465, kind: 'puzzle' },
      { id: 'item.life.wood_comb', label: '有裂缝的条纹物件', x: 320, y: 390, kind: 'pickup' },
      { id: 'item.life.enamel_cup', label: '带桂花圆点的物件', x: 693, y: 475, kind: 'pickup' },
      { id: 'item.life.cassette', label: '双线圈波纹物件', x: 870, y: 570, kind: 'pickup' },
      { id: 'slot.life.dresser', label: '镜台 · 条纹槽', x: 337, y: 276, kind: 'slot' },
      { id: 'slot.life.windowsill', label: '窗台 · 圆点槽', x: 528, y: 354, kind: 'slot' },
      { id: 'slot.life.radio', label: '收音机 · 波纹槽', x: 957, y: 370, kind: 'slot' },
...
export const checkpointSpawns: Readonly<Record<string, CheckpointSpawn>> = {
  ...
  'checkpoint.rain.complete': { chapterId: 'rain', x: 1090, y: 290, facing: 'up' },
  ...
  'checkpoint.life.complete': { chapterId: 'life', x: 680, y: 170, facing: 'up' },
