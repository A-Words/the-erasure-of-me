...
住宅建筑壳层采用 30°～35° 轻斜俯视；家具可按摆放方向采用合理转角，但必须共享一致的落地面和俯角观感。背景层只包含地板、墙体、房间开口、窗洞与晨光；床、床边桌、沙发、客厅边桌、椭圆木桌、厨房台柜、储物柜、玄关桌和入户门均由独立透明素材按坐标组合，不得烘焙回背景；入户门嵌入画面右墙开口。

住宅家具底座与墙体写入 `collision` 对象层，角色使用脚部小矩形碰撞，不允许进入家具底座；碰撞框只覆盖落地脚印，不覆盖家具整张图片，以便人物能走到家具后缘并触发正确遮挡。运行时以脚底/底座 Y 值排序，人物在家具后方时被挡住，在前方时覆盖家具。
